...
const CheckCircleIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 sm:h-20 sm:w-20 text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
<p className="text-slate-300 mb-1 text-sm sm:text-base">
            Your new tome has been successfully added to the archives.
          </p>
